declare namespace sn_impex {
	...
	class GlideExcelParser {
		 ...
		 * 
		 * Note: Do not set this value if using the [setSource()](dev.do#!/reference/api/rome/server/ "Defines an input source for parsing multiple times or parsing each worksheet in an Excel file.") method to parse the same source multiple times.
		 *
