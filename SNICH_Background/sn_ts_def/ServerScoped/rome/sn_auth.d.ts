declare namespace sn_auth {
	 ...
	 *   
	 *   
	 * Before using these APIs, you must [configure an authentication algorithm](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/credentials/task/configure-authentication-algorithm.html) to sign the request and associate it with the credential used to authenticate the request.  
	 *   
	...
	class HttpRequestAuthedData {
		 ...
		 *
		 *
		 * @returns {string} Text of the credential value.
		 */
		 ...
		 *
		 *
		 * @returns {string} Whether the signature is applied to the header, as a query parameter, or as a credential value.
		 * 
		 * Values include:
		 * 
		 * *   HEADER: The signature is applied to the request header.
		 * *   QUERY: The signature is applied as a query parameter.
		 * *   CREDENTIAL_VALUE: The signature is applied as a credential value.
		 */
		getDirective(): string
		 ...
		 * Use a credential value to store a cookie, signature, or other value needed for an authentication algorithm. For example, create a Get Connection Info (GCI) step with a script that retrieves and stores a one-time token for a REST or SOAP call.
		 * 		 * 
		 * 		 * Use the setCredentialValue() method to set the Credential Value data pill for REST, SOAP, and GCI steps in Flow Designer.
		 *
		 * @param {string} credential_value Text of the credential value.
		 *
		 * @returns {void} 
		 */
		setCredentialValue(credential_value: string): void
		
		/**
		 *
		 * Defines whether to apply the signature to the signed request in the header, as a query parameter, or as a credential value.
		 *
		 * @param {string} directive Whether to apply the signature to the header, query parameter, or credential value of the signed request.
		 * 
		 * Values include:
		 * 
	...
	class HttpRequestData {
		 ...
		 * 		 * 
		 * 		 * Note: You can only use this method in an IntegrationHub REST step. For more information, see [REST step](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/administer/flow-designer/reference/rest-request-action-designer-2.html).
		 *
		 *
		 ...
		 * Note: You can only use this method in an IntegrationHub REST step. For more information, see [REST step](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/administer/flow-designer/reference/rest-request-action-designer-2.html).
		 * 		 * 
		 * 		 * For more information about connection attributes, see [Create connection attributes for IntegrationHub](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/credentials/task/create-connection-attributes.html).
		 *
	...
	class RequestAuthAPI {
		...
		/**
		 *
		 * @param {{[fieldName: string]: string}} data HttpRequestData object that contains the unsigned REST request. Use the HttpRequestData class to build this object. See [HttpRequestData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestDataAPI&v=rome).
		 * @param {{[fieldName: string]: string}} credential Object that represents a record from the Credentials [discovery_credentials] table. Retrieve this object using the AuthCredential class. See [AuthCredential API](https://developer.servicenow.com/go_to_api.do?ID=AuthCredentialAPI&v=rome).
		 *
		 */
		 ...
		 *
		 *
		 * @returns {HttpRequestAuthedData} Object. Data to use to obtain information about the signed result. Use the methods in the HttpRequestAuthedData class to interact with the signed result. See [HttpRequestAuthedData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestAuthedDataAPI&v=rome).
		 */
		 ...
		 *
		 *
		 * @returns {AuthCredential} Object. Data to use to obtain information about the credential record used to sign the request. Use the methods in the AuthCredential class to interact with the credential. See [AuthCredential API](https://developer.servicenow.com/go_to_api.do?ID=AuthCredentialAPI&v=rome).
		 */
		 ...
		 *
		 *
		 * @returns {HttpRequestData} Object. Contains the unsigned REST request. Use the methods in the HttpRequestData class to interact with the request. See [HttpRequestData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestDataAPI&v=rome).
		 */
