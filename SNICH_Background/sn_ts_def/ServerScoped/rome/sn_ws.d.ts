declare namespace sn_ws {
	...
	/** 
	 * Use RESTAPIResponseStream methods to build web service APIs in the [Scripted REST API](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/integrate/custom_web_services/concept/c_CustomWebServices.html) feature.
	 * 
	 * Note: You cannot instantiate objects of this type. Objects of this type are created automatically and are accessible only in scripted REST API resource scripts.
	 * 
	 */
	...
	class RESTMessageV2 {
		 ...
		 * 		 * In the following example, replace REST_message_record with the name of the REST message record from your instance.
		 *
		 * @param {string} headerName Request header you want to get the value for.
		 *
		 * @returns {string} The value of the specified header.
		 */
		 ...
		 * 		 * In the following example, replace REST_message_record with the name of the REST message record from your instance.
		 *
		 * @param {string} userName Username you want to use to authenticate the REST message.
		 * @param {string} userPass Password for the specified user.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 * 		 * In the following example, replace REST_message_record with the name of the REST message record from your instance.
		 *
		 * @param {string} correlator Unique identifier
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * By default, the REST message uses the endpoint specified in the REST message record. Use this method to override this default. You must call this method when using the [RESTMessageV2 - RESTMessageV2()](dev.do#!/reference/api/rome/server/sn_ws-namespace/c_RESTMessageV2API#r_RMV2-RESTMessageV2 "Instantiates an empty RESTMessageV2 object.") constructor with no parameters.
		 *
		 ...
		 *
		 * You must set an HTTP method when using the [RESTMessageV2 - RESTMessageV2()](dev.do#!/reference/api/rome/server/sn_ws-namespace/c_RESTMessageV2API#r_RMV2-RESTMessageV2 "Instantiates an empty RESTMessageV2 object.") constructor with no parameters.
		 *
		 * @param {string} method HTTP method to perform.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 * In the following example, replace REST_message_record with the name of the REST message record from your instance.
		 *
		 * @param {number} timeoutMs Amount of time, in milliseconds, before the call to the REST provider times out.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} midServer Name of the MID Server to use. Your instance must have an active MID Server with the specified name.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} name Name of the URL parameter to pass.
		 * @param {string} value Value to assign the URL parameter.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} attachmentSysId Sys_id of the Attachment [sys_attachment] record you want to send in this REST message.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 * @param {string} value Value to assign to the specified header.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} name Name of the REST message variable. This parameter must be defined in the REST message record before you can assign a value to it.
		 * @param {string} value Value to assign the variable.
		 *
		 * @returns {void} Method does not return a value
		 */
	...
	class RESTResponseV2 {
		 ...
		 *
		 *
		 * @returns {string} REST response body.
		 */
		getBody(): string
		 ...
		 *
		 *
		 * @returns {number} Numeric error code, such as 1 for socket timeout.
		 */
		getErrorCode(): number
		 ...
		 *
		 * @param {string} name Name of the header that you want the value for, such as Set-Cookie.
		 *
		 * @returns {string} Value of the specified header.
		 */
		 ...
		 *
		 *
		 * @returns {{[fieldName: string]: string}} Object that maps the name of each header to the associated value.
		 */
		 ...
		 *
		 *
		 * @returns {string} Fully-resolved query.
		 */
		 ...
		 *
		 *
		 * @returns {string} Sys_id of the new attachment record.
		 */
		 ...
		 *
		 *
		 * @returns {number} Numeric status code returned by the REST provider, such as 200 for a successful response.
		 */
	 ...
	 * See also:
	 * 
	 * *   [Direct SOAPMessageV2 example](https://docs.servicenow.com/bundle/rome-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_DirectSOAPMessageV2Example.html)
	 * *   [Recordless SOAPMessageV2 example](https://docs.servicenow.com/bundle/rome-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_RecordlessSOAPMessageV2Example.html)
	 * *   [Asynchronous SOAPMessageV2 example](https://docs.servicenow.com/bundle/rome-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_AsyncronousSOAPMessageV2Example.html)
	 * *   [SOAPMessageV2 MID server example](https://docs.servicenow.com/bundle/rome-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_SOAPMessageV2MIDServerExample.html)
	 * 
	 */
	class SOAPMessageV2 {
		...
		/**
		 *
		 * @param {string} soapMessage SOAP message record you want to use as the base for this object.
		 * @param {string} soapFunction SOAP function you want to execute. Available SOAP functions depend on the WSDL supplied by the web service provider.
		 *
		 */
		 ...
		 *
		 *
		 * @returns {{[fieldName: string]: string}} Response returned by the SOAP provider.
		 */
		execute(): {[fieldName: string]: string}
		 ...
		 *
		 *
		 * @returns {string} URL of the SOAP web service provider.
		 */
		getEndpoint(): string
		 ...
		 *
		 * Note: Before calling the getRequestBody() method, you must call the [execute()](dev.do#!/reference/api/rome/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-execute "Sends the SOAP message to the endpoint.") method to obtain the response object.
		 *
		 *
		 ...
		 *
		 * @param {string} userName Username to use when authenticating the SOAP message.
		 * @param {string} userPass Password for the specified user.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} name Name of the ECC parameter.
		 * @param {string} value Value to assign to the specified ECC parameter.
		 *
		 * @returns {void} Method does not return a value
		 */
		setEccParameter(name: string, value: string): void
		 ...
		 *
		 * By default, the SOAP message uses the endpoint specified in the SOAP message record. Use this method to override the default. You must call this method when using the [SOAPMessageV2()](dev.do#!/reference/api/rome/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-SOAPMessageV2 "Instantiates an empty SOAPMessageV2 object.") constructor with no parameters.
		 *
		 * @param {string} endpoint URL of the SOAP web service provider you want to interface with.
		 *
		 * @returns {void} Method does not return a value
		 */
		setEndpoint(endpoint: string): void
		 ...
		 *
		 * @param {number} timeoutMs Amount of time to wait for a response from the web service provider, in milliseconds.
		 *
		 * @returns {void} Method does not return a value
		 */
		setHttpTimeout(timeoutMs: number): void
		 ...
		 *
		 * @param {string} midServerName Name of the MID Server you want to send the SOAP message through. Your instance must have an active MID Server with the specified name.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} profileName Name of the protocol profile to use for mutual authentication.
		 *
		 * @returns {void} Method does not return a value
		 */
		setMutualAuth(profileName: string): void
		 ...
		 *
		 * @param {string} requestBody Body of the SOAP message.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 * @param {string} headerValue Value to assign to the specified header.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * The WSDL for your web service provider lists SOAP actions you can perform. You must call this method when using the [SOAPMessageV2()](dev.do#!/reference/api/rome/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-SOAPMessageV2 "Instantiates an empty SOAPMessageV2 object.") constructor with no parameters.
		 *
		 * @param {string} soapAction SOAP action this SOAP message performs.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} name Name of the SOAP message variable.
		 * @param {string} value Value to assign to the specified variable.
		 *
		 * @returns {void} Method does not return a value
		 */
		setStringParameter(name: string, value: string): void
		 ...
		 *
		 * @param {string} keystoreId Sys_id of the Java or PKCS12 key store to use.
		 * @param {string} keystoreAlias Alias that identifies the public and private keys.
		 * @param {string} keystorePassword Password assigned to the key store record.
		 * @param {string} certificateId Sys_id of the trusted server certificate.
		 *
		 * @returns {void} Method does not return a value
		 */
	...
	class SOAPResponseV2 {
		 ...
		 *
		 *
		 * @returns {string} SOAP response body.
		 */
		getBody(): string
		 ...
		 *
		 *
		 * @returns {number} Numeric error code, such as 1 for a socket timeout.
		 */
		getErrorCode(): number
		 ...
		 *
		 *
		 * @returns {number} Numeric status code returned by the SOAP provider, such as 200 for a successful response.
		 */
		getStatusCode(): number
		 ...
		 *
		 * @param {number} timeoutSecs Amount of time, in seconds, to wait for this response.
		 *
		 * @returns {void} Method does not return a value
		 */
		waitForResponse(timeoutSecs: number): void
