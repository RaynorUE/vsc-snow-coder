declare namespace sn_connect {
	...
	class Queue {
		 ...
		 *
		 * Before calling this method, you must call the [Scoped Queue - get(String sysID)](dev.do#!/reference/api/rome/server/sn_connect-namespace/QueueScopedAPI#queue-get-string "Retrieves a specified chat queue.") method to retrieve the chat queue to which to attach the current user.
		 *
