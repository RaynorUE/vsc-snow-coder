declare namespace sn_cc {
	 ...
	 *   
	 * For more information on connections and credentials, see [Credentials and connection information](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/credentials/reference/r-credentials.html).  
	 *   
	...
	class ConnectionInfoProvider {
		 ...
		 *
		 * @param {string} aliasID Sys_id of a connection alias.
		 *
		 ...
		 *
		 * @param {string} aliasID Sys_id of a connection alias.
		 * @param {string} domainID Sys_id of a domain or global.
		 *
