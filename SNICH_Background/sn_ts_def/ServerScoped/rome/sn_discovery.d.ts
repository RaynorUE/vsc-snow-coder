declare namespace sn_discovery {
	...
	class DiscoveryAPI {
		 ...
		 *
		 * @returns {any[]} JavaScript array of immutable [ReportCiStatusOutputJS](dev.do#!/reference/api/rome/server/ "The ReportCiStatusOutputJS methods are getters that return specific object properties for the DiscoveryAPI reportCiIpAddressStatus method and then convert the information into a JSON string.") objects.
		 */
	...
	class ReportCiStatusOutputJS {
		 ...
		 *
		 * The values returned by this method are used to calculate the value returned by the [getCiOperationStatus()](dev.do#!/reference/api/rome/server/sn_discovery-namespace/c_ReportCiStatusOutputJSScopedAPI#r_RepCiStatOutgetCiOperationStatus "Used to return the state of the scanned CI.") method
		 *
		 *
