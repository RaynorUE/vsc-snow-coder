declare namespace sn_currency {
	...
	/** 
	 * You can acquire information for a specific FX Currency field by calling the [GlideCurrencyConfig(Object ed)](https://developer.servicenow.com/go_to_api.do?ID=S-GCConfig-GlideCurrencyConfig_O&v=rome) constructor, which associates a specific FX Currency field to the instantiated object. When calling the various GlideCurrencyConfig() methods, if a record exists in the FX Currency Configuration [fx_configuration] table for the FX Currency field, the requested value is passed back. If a record or field is not available, the default value is passed back. You can also acquire the default FX Currency configuration values by calling the [GlideCurrencyConfig()](https://developer.servicenow.com/go_to_api.do?ID=S-GCConfig-GlideCurrencyConfig&v=rome) constructor.  
	 *   
	 * For additional information on FX Currency configuration, see [Setting up and operating FX Currency fields](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/fx-currency.html).  
	 *   
	...
	class GlideCurrencyConfig {
		 ...
		 * 		 * 
		 * 		 * For more information on aggregation source, see [Specify the table field and its currency display parameters](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/configure-fx-currency-field-behavior.html#fx-currency-display-parameters).
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * For more information on rate table filters, see [Select the rate and target table fields used for filtering](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/configure-fx-currency-field-behavior.html#fx-currency-rate-target-table-fields).
		 *
		 *
		 ...
		 * If called on an existing FX Currency field that has a corresponding FX Currency Configuration [fx_configuration] record, returns the value of the Rate Table Field (rate_filter_rate_table_field). Otherwise, if a new record, returns a default value.
		 * 		 * 
		 * 		 * For more information on FX Currency rate tables, see [Identify the rate table and date source for currency conversions](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/configure-fx-currency-field-behavior.html#fx-currency-conv-rate-table-date-source).
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * For more information on reference currency, see [Set the reference currency](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/configure-fx-currency-field-behavior.html#fx-currency-set-reference).
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * For more information on reference currency source, see [Set the reference currency](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/currency/concept/configure-fx-currency-field-behavior.html#fx-currency-set-reference).
		 *
		 *
	...
	/** 
	 * Refer to the [GlideCurrencyConverter()](dev.do#!/reference/api/rome/server/sn_currency-namespace/GlideCurrConverterScopedAPI "The GlideCurrencyConverter API provides methods to convert one currency value to another, such as converting US dollars into European Euro.") API for methods that return a GlideCurrencyExchangeValue object.  
	 *   
	 * 
