declare namespace sn_cmdb {
	...
	class IdentificationEngine {
		 ...
		 * @param {{[fieldName: string]: string}} input.items.display_values Reference fields to create or update for this related item as name-value pairs, where the name is the field name and the value is the referenced display value. If you want to use the sys_id instead of the display value for reference fields, pass the information in the input.items.lookup.values parameter instead of in this parameter.
		 * 
		 ...
		 * @param {{[fieldName: string]: string}} input.items.lookup.values Fields to create or update for this related item as name/value pairs, where the name is the field name. For a reference field, the value must be the referenced sys_id. If you want to use the display value instead of the sys_id for reference fields, pass this information in a display_values object instead of in the values object.
		 * 
		 ...
		 * 
		 * Format: YYYY-MM-DD hh:mm:ss
		 * @param {{[fieldName: string]: string}} input.items.related.values Fields to create or update for this related item as name/value pairs, where the name is the field name. For a reference field, the value must be the referenced sys_id. If you want to use the display value instead of the sys_id for reference fields, pass this information in a display_values object instead of in the values object.
		 * 
		 * Field names and types depend on the fields selected by the user, such as:
		 * 
		 *     "values": {
		 ...
		 * 
		 * Format: YYYY-MM-DD hh:mm:ss
		 * @param {{[fieldName: string]: string}} input.items.values Fields to create or update for this related item as name/value pairs, where the name is the field name. For a reference field, the value must be the referenced sys_id. If you want to use the display value instead of the sys_id for reference fields, pass this information in a display_values object instead of in the values object.
		 * 
		 * Field names and types depend on the fields selected by the user, such as:
		 * 
		 *     "values": {
		 ...
		 * 		 * 
		 * 		 * For additional information on IRE and more detailed explanations of the data used by this method, see [Identification and Reconciliation (IRE)](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/configuration-management/concept/ire.html).
		 *
		 * @param {string} input Required. Input payload. A JSON formatted string of configuration items to add or update.
		 * 
		 *     "input" { 
		 ...
		 * 
		 * Default: false
		 * @param {boolean} options.partial_commits Flag that indicates whether partial commit support is enabled. For additional information on partial commits, see [Enhanced IRE features](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/configuration-management/concept/ire.html).
		 * 
		 * Valid values:
		 * 
		 ...
		 * 
		 * Default: true
		 * @param {boolean} options.partial_payloads Flag that indicates whether partial payload support is enabled. For additional information on partial payloads, see [Enhanced IRE features](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/configuration-management/concept/ire.html) and [Create an IRE data source rule](https://docs.servicenow.com/bundle/rome-servicenow-platform/page/product/configuration-management/task/create-ire-data-source-rule.html).
		 * 
		 * Valid values:
		 * 
		 ...
		 * 		 * 
		 * 		 * This method is similar to the [IdentificationEngine - identifyCI(String jsonString)](dev.do#!/reference/api/rome/server/sn_cmdb-namespace/IdentificationEngineScopedAPI#IESS-identifyCI_S "Determines the operation (insert/update) to perform with the specified payload without committing the operation in the database.") method, however it also supports the following functionality:
		 * 		 * 
		 * 		 * *   Partial payloads
