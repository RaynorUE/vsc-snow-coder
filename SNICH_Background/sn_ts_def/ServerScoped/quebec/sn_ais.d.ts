declare namespace sn_ais {
	...
	/** 
	 * You can populate the answer object with query details retrieved from the context of the Genius Result configuration using the [GeniusResultContext](dev.do#!/reference/api/quebec/server/sn_ais-namespace/GeniusResultContextAPI "The GeniusResultContext API provides methods for retrieving search query information from the context of a Genius Result configuration.") API.  
	 *   
