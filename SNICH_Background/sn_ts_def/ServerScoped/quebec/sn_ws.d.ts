declare namespace sn_ws {
	...
	/** 
	 * Use RESTAPIResponseStream methods to build web service APIs in the [Scripted REST API](https://docs.servicenow.com/bundle/quebec-application-development/page/integrate/custom-web-services/concept/c_CustomWebServices.html) feature.
	 * 
	 * Note: You cannot instantiate objects of this type. Objects of this type are created automatically and are accessible only in scripted REST API resource scripts.
	 * 
	 */
	...
	class RESTMessageV2 {
		 ...
		 *
		 * By default, the REST message uses the endpoint specified in the REST message record. Use this method to override this default. You must call this method when using the [RESTMessageV2 - RESTMessageV2()](dev.do#!/reference/api/quebec/server/sn_ws-namespace/c_RESTMessageV2API#r_RMV2-RESTMessageV2 "Instantiates an empty RESTMessageV2 object.") constructor with no parameters.
		 *
		 ...
		 *
		 * You must set an HTTP method when using the [RESTMessageV2 - RESTMessageV2()](dev.do#!/reference/api/quebec/server/sn_ws-namespace/c_RESTMessageV2API#r_RMV2-RESTMessageV2 "Instantiates an empty RESTMessageV2 object.") constructor with no parameters.
		 *
	 ...
	 * See also:
	 * 
	 * *   [Direct SOAPMessageV2 example](https://docs.servicenow.com/bundle/quebec-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_DirectSOAPMessageV2Example.html)
	 * *   [Recordless SOAPMessageV2 example](https://docs.servicenow.com/bundle/quebec-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_RecordlessSOAPMessageV2Example.html)
	 * *   [Asynchronous SOAPMessageV2 example](https://docs.servicenow.com/bundle/quebec-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_AsyncronousSOAPMessageV2Example.html)
	 * *   [SOAPMessageV2 MID server example](https://docs.servicenow.com/bundle/quebec-application-development/page/app-store/dev_portal/API_reference/SOAPMessageV2/reference/r_SOAPMessageV2MIDServerExample.html)
	 * 
	 */
	class SOAPMessageV2 {
		 ...
		 *
		 * Note: Before calling the getRequestBody() method, you must call the [execute()](dev.do#!/reference/api/quebec/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-execute "Sends the SOAP message to the endpoint.") method to obtain the response object.
		 *
		 *
		 ...
		 *
		 * By default, the SOAP message uses the endpoint specified in the SOAP message record. Use this method to override the default. You must call this method when using the [SOAPMessageV2()](dev.do#!/reference/api/quebec/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-SOAPMessageV2 "Instantiates an empty SOAPMessageV2 object.") constructor with no parameters.
		 *
		 ...
		 *
		 * The WSDL for your web service provider lists SOAP actions you can perform. You must call this method when using the [SOAPMessageV2()](dev.do#!/reference/api/quebec/server/sn_ws-namespace/c_SOAPMessageV2API#r_SMV2-SOAPMessageV2 "Instantiates an empty SOAPMessageV2 object.") constructor with no parameters.
		 *
