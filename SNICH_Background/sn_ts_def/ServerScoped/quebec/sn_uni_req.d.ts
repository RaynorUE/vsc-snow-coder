declare namespace sn_uni_req {
	 ...
	 * 
	 * For information, refer to [Universal Request](https://docs.servicenow.com/bundle/quebec-employee-service-management/page/product/universal-request/concept/ur-landing-limitedaccess.html).
	 * 
	 */
	class UniversalRequestUtilsSNC {
		 ...
		 * };
		 * 
		 * Other fields not listed might be eligible for your use case. For a list of table fields and related fields in the system, view the [data dictionary](https://docs.servicenow.com/bundle/quebec-platform-administration/page/administer/managing-data/concept/c_DataDictionaryTables.html).
		 * 
		 ...
		 * 
		 * Default: 3
		 * @param {boolean} copyFields.restricted Optional. Flag that indicates if the universal request has restricted access. Refer to [Universal Request roles and groups](https://docs.servicenow.com/bundle/quebec-employee-service-management/page/product/universal-request/concept/ur-roles.html).
		 * 
		 * Valid values:
		 * 
