declare namespace sn_fd {
	...
	/** 
	 * This API is deprecated and replaced by the [FlowAPI - Scoped, Global](dev.do#!/reference/api/quebec/server/sn_fd-namespace/ScriptableFlowAPI "Use FlowAPI methods to execute actions, flows, or subflows in server-side scripts using either blocking or non-blocking methods.") and [ScriptableFlowRunner - Scoped](dev.do#!/reference/api/quebec/server/sn_fd-namespace/ScriptableFlowRunnerScopedAPI "Create a builder object used to define parameters for flow, subflow, and action execution. You can specify a flow to execute in a particular domain. Start the flow, subflow, or action execution directly from the builder and view the results in a ScriptableFlowRunnerResult object.") APIs.  
	 *   
	...
	class FlowAPI {
		 ...
		 * 		 * 
		 * 		 * Note: This API is replaced by [ScriptableFlowRunner](https://developer.servicenow.com/go_to_api.do?ID=ScriptableFlowRunnerScopedAPI&v=quebec), which deprecates the existing methods used to build objects and execute Flow Designer flows and actions. Use the getRunner() method in the FlowAPI class to return a ScriptableFlowRunner object and use the associated methods. Use the ScriptableFlowRunner methods if you need to support domain separation.
		 * 		 * 
		 ...
		 *
		 * For more information about Data Stream actions, see [Data Stream actions and pagination](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/integrationhub/concept/data-stream-actions.html).
		 * 		 * 
		 * 		 * Note: This API is replaced by [ScriptableFlowRunner](https://developer.servicenow.com/go_to_api.do?ID=ScriptableFlowRunnerScopedAPI&v=quebec), which deprecates the existing methods used to build objects and execute Flow Designer flows and actions. Use the getRunner() method in the FlowAPI class to return a ScriptableFlowRunner object and use the associated methods. Use the ScriptableFlowRunner methods if you need to support domain separation.
		 * 		 * 
		 ...
		 * Unit: Milliseconds
		 *
		 * @returns {ScriptableDataStream} An object used to iterate through items in the data stream. Use the methods in the ScriptableDataStream class to interact with this object. See [ScriptableDataStream API](https://developer.servicenow.com/go_to_api.do?ID=ScriptableDataStreamAPI&v=quebec).
		 */
	 ...
	 *   
	 * 
	 * *   The executeDataStreamAction() method in the FlowAPI class. See [FlowAPI](https://developer.servicenow.com/go_to_api.do?ID=ScriptableFlowAPI&v=quebec).
	 * *   The getDataStream() method in the ScriptableFlowRunnerResult class. See [ScriptableFlowRunnerResult](dev.do#!/reference/api/quebec/server/sn_fd-namespace/ScriptableFlowRunnerResultScopedAPI "Captures the result of using ScriptableFlowRunner to execute a flow, subflow, or action. Includes data such as the context ID, domain, and any outputs from the flow execution.").
	 * 
	 *   
	 *   
	...
	class ScriptableFlowRunner {
		 ...
		 *
		 * To learn more about data stream actions, see [Data Stream actions and pagination](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/integrationhub/concept/data-stream-actions.html).
		 *
		 ...
		 *
		 * To learn more about overriding a Connections and Credentials alias, see [Supporting multiple connections](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/integrationhub/concept/support-multiple-connections.html).
		 *
	...
	class ScriptableFlowRunnerResult {
		 ...
		 *
		 * If the datastream() method was used in the ScriptableFlowRunner builder class, this returns the stream of data as a ScriptableDataStream object. Use the ScriptableDataStream class to iterate over items in the stream. See [ScriptableDataStream](dev.do#!/reference/api/quebec/server/sn_fd-namespace/ScriptableDataStreamAPI "Provides methods to interact with a stream of data.").
		 * 		 * 
		 * 		 * For more information about data stream actions, see [Data Stream actions and pagination](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/integrationhub/concept/data-stream-actions.html).
		 *
		 *
		 * @returns {ScriptableDataStream} A ScriptableDataStream object you can use to iterate through items in a data stream. Use the methods in the ScriptableDataStream class to interact with this object. See [ScriptableDataStream](https://developer.servicenow.com/go_to_api.do?ID=ScriptableDataStreamAPI&v=quebec).
		 */
	...
	/** 
	 * This API is deprecated and replaced by the [FlowAPI - Scoped, Global](dev.do#!/reference/api/quebec/server/sn_fd-namespace/ScriptableFlowAPI "Use FlowAPI methods to execute actions, flows, or subflows in server-side scripts using either blocking or non-blocking methods.").  
	 *   
