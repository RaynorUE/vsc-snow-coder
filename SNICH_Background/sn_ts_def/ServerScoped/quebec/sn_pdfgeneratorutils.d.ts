declare namespace sn_pdfgeneratorutils {
	 ...
	 *   
	 * This API is a component used with the [Document API](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/DocumentBothAPI "The Document API provides methods to initialize a PDF, add content, and close the PDF. After adding content, the document can be attached to a target record.") to generate a PDF.
	 * 
	 */
	class Cell {
		 ...
		 * See also:
		 * 		 * 
		 * 		 * *   [setPaddingBottom()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingBottom_N "Sets the value of the bottom padding width of a cell.")
		 * 		 * *   [setPaddingLeft()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingLeft_N "Sets the value of the left padding width of a cell.")
		 * 		 * *   [setPaddingRight()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingRight_N "Sets the value of the right padding width of a cell.")
		 * 		 * *   [setPaddingTop()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingTop_N "Sets the value of the top padding width of a cell.")
		 *
		 ...
		 * See also:
		 * 		 * 
		 * 		 * *   [setPadding()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPadding_N "Sets the padding of all four sides of a cell to the same width.")
		 * 		 * *   [setPaddingLeft()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingLeft_N "Sets the value of the left padding width of a cell.")
		 * 		 * *   [setPaddingRight()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingRight_N "Sets the value of the right padding width of a cell.")
		 * 		 * *   [setPaddingTop()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-setPaddingTop_N "Sets the value of the top padding width of a cell.")
		 *
	 ...
	 * 
	 * *   [Cell](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI "Creates a Cell object as a cell in a table. You can use this API to format the cell and include additional blocks, such as paragraphs and images.") – Creates a Cell object as a cell in a table. You can use this API to format the cell and include additional blocks, such as paragraphs and images.
	 * *   [Color](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ColorBothAPI "Creates a Color object used to define color attributes that you can apply to elements in a PDF; such as cells, tables, and lines.") – Creates a Color object used to define color attributes that you can apply to elements in a PDF; such as cells, tables, and lines.
	 * *   [Image](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ImageBothAPI "Creates an Image object representing an image and its layout insert in a PDF. Enables defining attributes such as scale, alignment, and border color.") – Creates an Image object representing an image and its layout insert in a PDF. Enables defining attributes such as scale, alignment, and border color.
	 * *   [Line](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/LineBothAPI "Creates a Line object using methods to draw a line in a PDF.") – Creates a Line object using methods to draw a line in a PDF.
	 * *   [Paragraph](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ParagraphBothAPI "Creates a Paragraph object representing a block of text in a PDF.") – Creates a Paragraph object representing a block of text in a PDF.
	 * *   [PdfPage](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PdfPageBothAPI "Creates a PdfPage object representing a PDF page and its attributes; such as size, width, and color.") – Creates a PdfPage object representing a PDF page and its attributes; such as size, width, and color.
	 * *   [Style](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI "Creates a style for defining properties such font size, border, and alignment. You can apply the same style to multiple objects simultaneously.") – Creates a style for defining properties such font size, border, and alignment. You can apply the same style to multiple objects simultaneously.
	 * *   [Table](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/TableBothAPI "Creates a Table object to add to a PDF document. Defines the data to use in each cell and sets styles, margins, and alignment.") – Creates a Table object to add to a PDF document. Defines the data to use in each cell and sets styles, margins, and alignment.
	 * 
	 *   
	 *   
	 * 
	 ...
	 * 
	 * ![Example PDF with output as 2-column table listing incident numbers and descriptions.](app_store_portal_api_reference_scoped_quebec_app-store_dev_portal_API_reference_DocumentBoth_image_document-api-pdf-output.png)
	 * 
	 */
	class Document {
		 ...
		 * Additional methods for adding a new page in a document:
		 * 		 * 
		 * 		 * *   [addAndStartNewPage()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/DocumentBothAPI#Document-addAndStartNewPage "Adds a page to the document by terminating the current page and creating a new one.") – Adds a page to the document by terminating the current page and creating a new one.
		 * 		 * *   [addNewPageAtIndex()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/DocumentBothAPI#Document-addNewPageAtIndex_N "Adds a new page at the specified index of the document. For example, setting the index to 6 inserts a page six or inserts the page at the position of the existing page six in a document. The original page six becomes page seven.") – Adds a new page at the specified index of the document. For example, setting the index to 6 inserts a page six or inserts the page at the position of the existing page six in a document. The original page six becomes page seven.
		 *
		 *
		 * @returns {void} 
		 ...
		 *
		 *
		 * @returns {string} Value of the default page size set using the [PdfPage](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PdfPageBothAPI "Creates a PdfPage object representing a PDF page and its attributes; such as size, width, and color.") API.
		 * 
		 * Possible values:
		 * 
		 * *   A4 – 595 x 842 points
	 ...
	 * 
	 * *   [Cell – addImage(Image image)](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-addImage_O "Adds an image to a table cell.") – Adds an image to a table cell
	 * *   [Table – addImageCell(Image image)](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/TableBothAPI#Table-addImageCell_O "Adds a cell that contains an image to the table.") – Adds a cell that contains an image to a table.
	 * *   [Document – addImage(Image image)](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/DocumentBothAPI#Document-addImage_O "Adds an image to a document.") - Adds an image to a page
	 * 
	 */
	class Image {
		 ...
		 *
		 * To scale to an absolute size that preserves width-height ratio of an image, use the [scaleToFit()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ImageBothAPI#Image-scaleToFit_N_N "Scales an image to an absolute size while preserving the width-height ratio.") method.
		 *
	...
	class Paragraph {
		 ...
		 *
		 * To set all four margins with one or more unique values, use [setMargins()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ParagraphBothAPI#Paragraph-setMargins_N_N_N_N "Sets a size for each paragraph margin.").
		 *
		 ...
		 *
		 * To set each margin to the same value, use [setMargin()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ParagraphBothAPI#Paragraph-setMargin_N "Sets each paragraph margin.").
		 *
		 * @param {number} topMargin Height of the top margin in points.
		 * @param {number} rightMargin Width of the right margin in points.
		 * @param {number} bottomMargin Height of the bottom margin in points.
	 ...
	 * Related APIs:
	 * 
	 * *   [PdfMergeSignRequestor](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PdfMergeSignRequestorBothAPI "Adds an image representing a signature to a PDF document.")
	 * *   [SVGToPDFConversionAPI](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/SVGToPDFConversionAPIBothAPI "Enables adding an SVG to a PDF and converting an SVG to PDF.")
	 * 
	 */
	class PDFGenerationAPI {
		 ...
		 *
		 * To generate a PDF with header and footer information, such as page numbers, use [convertToPDFWithHeaderFooter()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-convertToPDFWithHdrFtr_S_S_S_S_O "Converts an HTML string into a PDF with header and footer content.").
		 *
		 ...
		 * 		 * 
		 * 		 * *   [isDocumentFillable()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-isDocumentFillable_S "Checks if the PDF document contains editable fields.")
		 * 		 * *   [getDocumentFields()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-getDocumentFields_S "Gets a list of editable fields in a PDF document. Enables listing editable PDF fields without manually opening the file to check.")
		 * 		 * *   [getDocumentFieldsType()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-getDocumentFieldsType_S "Gets the field type of set of editable fields from a PDF document.")
		 * 		 * 
		 * 		 * PDFGenerationAPI provides additional fill methods with different options:
		 * 		 * 
		 * 		 * *   [fillDocumentFieldsandFlatten()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-fillDocFieldsFlatten_O_S_S_S_S_O "Fills fields in an editable PDF, flattens the data fields, and attaches it to the provided record.") – Fills fields in an editable PDF, flattens the data fields, and attaches it to the provided record.
		 * 		 * *   [fillFieldsAndMergeSignature()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-fillFieldsMergeSig_O_S_S_S_S_O_O "Fills fields in an editable PDF, adds signature image, flattens the data fields, and attaches it to the provided record.") – Fills fields in an editable PDF, adds signature image, flattens the data fields, and attaches it to the provided record.
		 * 		 * *   [getFilledDocumentWithSignatureAsBase64()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-getFilDocWithSigAsBase64_O_S_O_O "Fills fields in an editable PDF, creates an image, and converts it to a Base64-encoded PDF.") – Fills fields in an editable PDF, creates an image, and converts it to a Base64-encoded PDF.
		 *
		 ...
		 * 		 * PDFGenerationAPI provides additional fill methods with different options:
		 * 		 * 
		 * 		 * *   [fillDocumentFields()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-fillDocumentFields_O_S_S_S_S "Fills fields in an editable PDF and attaches it to the provided record.") – Fills fields in an editable PDF and attaches it to the provided record.
		 * 		 * *   [fillFieldsAndMergeSignature()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-fillFieldsMergeSig_O_S_S_S_S_O_O "Fills fields in an editable PDF, adds signature image, flattens the data fields, and attaches it to the provided record.") – Fills fields in an editable PDF, adds signature image, flattens the data fields, and attaches it to the provided record.
		 * 		 * *   [getFilledDocumentWithSignatureAsBase64()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI#P-getFilDocWithSigAsBase64_O_S_O_O "Fills fields in an editable PDF, creates an image, and converts it to a Base64-encoded PDF.") – Fills fields in an editable PDF, creates an image, and converts it to a Base64-encoded PDF.
		 *
		 * @param {{[fieldName: string]: string}} fieldsMap Optional. Key value map by PDF field name and value to fill. Use the getDocumentFields() method to get the list of available fields.
	 ...
	 * This API is part of the ServiceNow PDF Generation Utilities plugin (com.snc.apppdfgenerator) and is provided within the sn_pdfgeneratorutils namespace. The plugin is activated by default.  
	 *   
	 * This method creates a signature object that can be implemented in a PDF using [PDFGenerationAPI](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI "Provides support for PDF conversion and handling PDF fields.").
	 * 
	 */
	 ...
	 * 
	 * *   [Cell](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI#Cell-addStyle_O "Applies a predefined style to table cells.")
	 * *   [Paragraph](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ParagraphBothAPI#Paragraph-addStyle_O "Applies a predefined style to paragraph text.")
	 * *   [Table](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/TableBothAPI#Table-setDefaultStyle_O "Sets the default style to apply to the table.")
	 * 
	 */
	class Style {
		 ...
		 * See also:
		 * 		 * 
		 * 		 * *   [setPaddingBottom()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingBottom_N "Sets the value of the bottom padding width of an element.")
		 * 		 * *   [setPaddingLeft()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingLeft_N "Sets the value of the left padding width of an element.")
		 * 		 * *   [setPaddingRight()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingRight_N "Sets the value of the right padding width of a style.")
		 * 		 * *   [setPaddingTop()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingTop_N "Sets the value of the top padding width of an element.")
		 *
		 * @param {number} padding Padding width in points as a decimal value.
		 *
		 * @returns {void} 
		 ...
		 * See also:
		 * 		 * 
		 * 		 * *   [setPadding()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPadding_N "Sets the padding of all four sides of an element to the same width.")
		 * 		 * *   [setPaddingLeft()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingLeft_N "Sets the value of the left padding width of an element.")
		 * 		 * *   [setPaddingRight()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingRight_N "Sets the value of the right padding width of a style.")
		 * 		 * *   [setPaddingTop()](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI#Style-setPaddingTop_N "Sets the value of the top padding width of an element.")
		 *
	 ...
	 * This API is part of the ServiceNow PDF Generation Utilities plugin (com.snc.apppdfgenerator) and is provided within the sn_pdfgeneratorutils namespace. The plugin is activated by default.  
	 *   
	 * See also [PDFGenerationAPI](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/PDFGenerationAPIBothAPI "Provides support for PDF conversion and handling PDF fields.").
	 * 
	 */
	 ...
	 * 
	 * [Cell API](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/CellBothAPI "Creates a Cell object as a cell in a table. You can use this API to format the cell and include additional blocks, such as paragraphs and images.")
	 * 
	 ...
	 * *   Table.addTextCell()
	 * 
	 * [Paragraph API](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/ParagraphBothAPI "Creates a Paragraph object representing a block of text in a PDF.")
	 * 
	 * Create a paragraph using the Paragraph API. Add the paragraph to a cell in the table using Cell.addParagraph().
	 * 
	 * [Style API](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/StyleBothAPI "Creates a style for defining properties such font size, border, and alignment. You can apply the same style to multiple objects simultaneously.")
	 * 
	 ...
	 * 
	 * [Document API](dev.do#!/reference/api/quebec/server/sn_pdfgeneratorutils-namespace/DocumentBothAPI "The Document API provides methods to initialize a PDF, add content, and close the PDF. After adding content, the document can be attached to a target record.")
	 * 
