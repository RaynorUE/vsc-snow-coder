declare namespace sn_dt {
	...
	/** 
	 * Access DecisionTableAPI methods using the sn_dt namespace. To learn more about Decision Tables, see [Decision Tables](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/decision-table/concept/decision-table.html).
	 * 
	 */
