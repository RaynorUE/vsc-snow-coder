declare namespace sn_clotho {
	...
	class Client {
		 ...
		 * 
		 * *   [DataBuilder](https://docs.servicenow.com/bundle/quebec-application-development/page/app-store/dev_portal/API_reference/DataBuilderScoped/concept/DataBuilderScopedAPI.html) object containing metric data.
	...
	class TransformPart {
		 ...
		 * *   STDDEV
		 * 
		 * For definitions of these options, see [MetricBase transforms](https://docs.servicenow.com/bundle/quebec-now-intelligence/page/use/reporting/reference/metricbase-transforms.html).
