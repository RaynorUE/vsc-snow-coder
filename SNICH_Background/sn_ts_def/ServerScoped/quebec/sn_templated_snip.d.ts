declare namespace sn_templated_snip {
	 ...
	 *   
	 * For additional information on response templates, see [Response templates](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/product/human-resources/concept/response-templates-templated-snippets.html).
	 * 
	 */
