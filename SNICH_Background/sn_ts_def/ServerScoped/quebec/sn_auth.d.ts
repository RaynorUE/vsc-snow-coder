declare namespace sn_auth {
	 ...
	 *   
	 *   
	 * Before using these APIs, you must [configure an authentication algorithm](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/product/credentials/task/configure-authentication-algorithm.html) to sign the request and associate it with the credential used to authenticate the request.  
	 *   
	...
	class HttpRequestData {
		 ...
		 * 		 * 
		 * 		 * Note: You can only use this method in an IntegrationHub REST step. For more information, see [REST step](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/flow-designer/reference/rest-request-action-designer-2.html).
		 *
		 *
		 ...
		 * Note: You can only use this method in an IntegrationHub REST step. For more information, see [REST step](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/administer/flow-designer/reference/rest-request-action-designer-2.html).
		 * 		 * 
		 * 		 * For more information about connection attributes, see [Create connection attributes for IntegrationHub](https://docs.servicenow.com/bundle/quebec-servicenow-platform/page/product/credentials/task/create-connection-attributes.html).
		 *
	...
	class RequestAuthAPI {
		...
		/**
		 *
		 * @param {{[fieldName: string]: string}} data HttpRequestData object that contains the unsigned REST request. Use the HttpRequestData class to build this object. See [HttpRequestData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestDataAPI&v=quebec).
		 * @param {{[fieldName: string]: string}} credential Object that represents a record from the Credentials [discovery_credentials] table. Retrieve this object using the AuthCredential class. See [AuthCredential API](https://developer.servicenow.com/go_to_api.do?ID=AuthCredentialAPI&v=quebec).
		 *
		 */
		 ...
		 *
		 *
		 * @returns {HttpRequestAuthedData} Object. Data to use to obtain information about the signed result. Use the methods in the HttpRequestAuthedData class to interact with the signed result. See [HttpRequestAuthedData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestAuthedDataAPI&v=quebec).
		 */
		 ...
		 *
		 *
		 * @returns {AuthCredential} Object. Data to use to obtain information about the credential record used to sign the request. Use the methods in the AuthCredential class to interact with the credential. See [AuthCredential API](https://developer.servicenow.com/go_to_api.do?ID=AuthCredentialAPI&v=quebec).
		 */
		 ...
		 *
		 *
		 * @returns {HttpRequestData} Object. Contains the unsigned REST request. Use the methods in the HttpRequestData class to interact with the request. See [HttpRequestData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestDataAPI&v=quebec).
		 */
