declare namespace sn_cti_core {
	 ...
	 *   
	 *   
	 * For additional information on creating operation handlers, see [Configure a contact flow for an automated caller interaction](https://docs.servicenow.com/bundle/orlando-servicenow-platform/page/product/cloud-call-center/task/establish-automated-bot-interactions.html).  
	 *   
	 * This API runs in the sn_cti_core namespace. Before you are able to access the CTIOperationRequest API, the Cloud Call Center Core (sn_cti_core) plugin must be activated. For information on activating the Cloud Call Center, see [Install Cloud Call Center applications](https://docs.servicenow.com/bundle/orlando-servicenow-platform/page/product/cloud-call-center/task/install-ccc-apps.html).  
	 *   
	 * For additional information on the Cloud Call Center, see [Cloud Call Center](https://docs.servicenow.com/bundle/orlando-servicenow-platform/page/product/cloud-call-center/concept/cloud-call-center-overview.html).
	 * 
	 */
	class CTIOperationRequest {
		 ...
		 * 		 * 
		 * 		 * Interaction records are associated with a CTIOperationRequest object through the [CTIOperationRequest - setInteractionSysId(String Id)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setInteractionSysId_S&v=orlando) method. This method is typically called by the message transformer and must be called prior to calling the getInteractionRecord() method.
		 *
		 *
		 ...
		 *
		 * The [CTIOperationRequest - setInteractionSysId(String Id)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setInteractionSysId_S&v=orlando) method must have been called prior to calling this method.
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * Typically an operation handler calls the getLanguage() method and the message transformer sets the language on the CTIOperationRequest object by calling the [CTIOperationRequest - setLanguage(String languageCode)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setLanguage_S&v=orlando) method.
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * Typically the message transformer sets the software version on the CTIOperationRequest object by calling the [CTIOperationRequest - setMajorVersion(Number majorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMajorVersion_N&v=orlando) method and an operation handler then consumes the set value using this method. You can also get/set the minor version value of a provider's software using the [CTIOperationRequest - getMinorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMinorVersion&v=orlando) and [CTIOperationRequest - setMinorVersion(Number minorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMinorVersion_N&v=orlando) methods.
		 *
		 *
		 ...
		 * Use this method if the CTI providers connected to your ServiceNow instance are running multiple versions of their software, as different software versions may require different processing behavior. If the processing behavior is only slightly different between the software versions, it may make sense to have only a single operation handler. You can then handle the processing differences by just checking the version of software making the request and process the request/data within your operation handler. If the required processing is significantly different between versions, it may be more effective to use multiple operation handlers.
		 * 		 * 
		 * 		 * Typically the message transformer sets the software version on the CTIOperationRequest object by calling the [CTIOperationRequest - setMinorVersion(Number minorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMinorVersion_N&v=orlando)[CTIOperationRequest - setMinorVersion(Number minorVersion)](dev.do#!/reference/api/orlando/server/sn_cti_core-namespace/CTIOperationRequestAPI#CTIOpReq-setMinorVersion_N "Sets the minor version of the computer telephony integrator (CTI) provider software making the request on the associated CTIOperationRequest object.") method and an operation handler then consumes the set value using this method. You can also get/set the major version value of a provider's software using the [CTIOperationRequest - getMajorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMajorVersion&v=orlando)[CTIOperationRequest - getMajorVersion()](dev.do#!/reference/api/orlando/server/sn_cti_core-namespace/CTIOperationRequestAPI#CTIOpReq-getMajorVersion "Returns the major version of the computer telephony integrator (CTI) software set on the current CTIOperationRequest object.") and [CTIOperationRequest - setMajorVersion(Number majorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMajorVersion_N&v=orlando)[CTIOperationRequest - setMajorVersion(Number majorVersion)](dev.do#!/reference/api/orlando/server/sn_cti_core-namespace/CTIOperationRequestAPI#CTIOpReq-setMajorVersion_N "Sets the major version of the computer telephony integrator (CTI) provider software making the request on the associated CTIOperationRequest object.") methods.
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * Typically the message transformer sets the substep name on the CTIOperationRequest object using the [CTIOperationRequest - setOperationSubStepName(String name)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setOperationSubStepName_S&v=orlando) method. You can override this behavior if you are creating your own transformer by calling the [CTIOperationRequest - setSubStepNotFoundBehaviour(Object behaviour)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setSubStepNotFoundBehav_O&v=orlando) method.
		 *
		 *
		 ...
		 * 		 * 
		 * 		 * The [CTIOperationRequest - getInteractionRecord()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getInteractionRecord&v=orlando) method uses this sys_id to obtain the correct interaction record for the contact session. Interaction records are located in the Interaction [interaction] table. For additional information on interaction records, see
		 *
		 ...
		 * Use this method if the CTI providers connected to your ServiceNow instance are running multiple versions of their software, as different software versions may require different processing behavior. If the processing behavior is only slightly different between the software versions, it may make sense to have only a single operation handler. You can then handle the processing differences by just checking the version of software making the request and process the request/data within your operation handler. If the required processing is significantly different between versions, it may be more effective to use multiple operation handlers.
		 * 		 * 
		 * 		 * Typically the message transformer sets the software version on the CTIOperationRequest object by calling this method and an operation handler then consumes the set value using the [CTIOperationRequest - getMajorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMajorVersion&v=orlando) method. You can also get/set the minor version value of a provider's software using the [CTIOperationRequest - getMinorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMinorVersion&v=orlando) and [CTIOperationRequest - setMinorVersion(Number minorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMinorVersion_N&v=orlando) methods.
		 *
		 ...
		 * Use this method if the CTI providers connected to your ServiceNow instance are running multiple versions of their software, as different software versions may require different processing behavior. If the processing behavior is only slightly different between the software versions, it may make sense to have only a single operation handler. You can then handle the processing differences by just checking the version of software making the request and process the request/data within your operation handler. If the required processing is significantly different between versions, it may be more effective to use multiple operation handlers.
		 * 		 * 
		 * 		 * Typically the message transformer sets the software version on the CTIOperationRequest object by calling this method and an operation handler then consumes the set value using the [CTIOperationRequest - getMinorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMinorVersion&v=orlando) method. You can also get/set the major version value of a provider's software using the [CTIOperationRequest - getMajorVersion()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getMajorVersion&v=orlando) and [CTIOperationRequest - setMajorVersion(Number majorVersion)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setMajorVersion_N&v=orlando) methods.
		 *
		 ...
		 * 		 * 4.  Executes the primary operation handler (myOpersation_SUFFX or myOperation.)
		 * 		 * 
		 * 		 * You can set the default behavior of a substep by calling the [CTIOperationRequest - setSubStepNotFoundBehaviour(Object behaviour)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-setSubStepNotFoundBehav_O&v=orlando) method.
		 *
		 ...
		 *
		 * Using the get/set parameter methods enables the passing of virtually any string or number value between a message transformer and an operation handler. The parameter object can contain zero or more key/value pairs of data that directly correlate to the current operation request. The operation handler determines what key/value pairs are required as it consumes these values. Typically the message transformer sets these parameters on the CTIOperationRequest object by calling this method and the operation handler consumes them using the [CTIOperationRequest - getParameter(String key)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getParameter_S&v=orlando) or [CTIOperationRequest - getParameters()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getParameters&v=orlando) method.
		 * 		 * 
		 ...
		 *
		 * Using the get/set session attribute methods enables the passing of virtually any string or number value between a message transformer and an operation handler. The sessionAttribute object can contain zero or more key/value pairs of data that are valid for the duration of a computer telephony integration provider defined session. Session attributes can also be accessed within a contact flow. The operation handler determines what session attribute key/value pairs are needed as it consumes these values. Typically the message transformer sets these attributes on the CTIOperationRequest object by calling this method and the operation handler gets the attributes using the [CTIOperationRequest - getSessionAttribute(String key)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getSessionAttribute_S&v=orlando) or [CTIOperationRequest - getSessionAttribute()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpReq-getSessionAttributes&v=orlando) method.
		 * 		 * 
		 * 		 * Note: You should only store objects that can survive a JSON.parse(JSON.stringify(object)) operation. Objects not meeting this criteria may not propagate correctly through the entire operation processing chain.
		 * 		 * 
		 * 		 * For example:
	...
	class CTIOperationResponse {
		 ...
		 *
		 * The [CTIOperationResponse - setInteractionSysId(String Id)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-setInteractionSysId_S&v=newyork) method must have been called prior to calling this method.
		 *
		 *
		 ...
		 *
		 * Typically this is a message that is spoken back to the user once an operation is complete. You can set this value using the [CTIOperationResponse - setMessage(String message)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-setMessage_S&v=newyork) method.
		 *
		 *
		 ...
		 *
		 * Using the get/set parameter methods enables the passing of virtually any string or number value between an operation handler and a message transformer. The parameter object can contain zero or more key/value pairs of data that directly correlate to the current operation response. The operation handler determines what key/value pairs are required as it produces these values. Use the [CTIOperationResponse - setParameter(String key, Object value)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-setParameter_S_O&v=newyork) method to set parameters on the current CTIOperationResponse object.
		 *
		 * @param {string} key The name of the key value to return.
		 *
		 ...
		 *
		 * These status codes should correspond with standard HTTP status codes, such as 200 for success, 401 for authorization required. Typically, the resultant status codes are determined by the operation handler and are set on the CTIOperationResponse object using the [CTIOperationResponse - setStatusCode(String statusCode)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-setStatusCode_N&v=newyork) method. The message transformer then uses this method to include the status code in the payload returned to the computer telephony integrator provider.
		 *
		 *
		 ...
		 *
		 * Using the get/set parameter methods enables the passing of virtually any string or number value between an operation handler and a message transformer. The parameter object can contain zero or more key/value pairs of data that directly correlate to the current operation request. The operation handler determines what key/value pairs are required as it consumes these values. Typically the operation handler sets these parameters on the CTIOperationResponse object by calling this method and the message transformer consumes them using the [CTIOperationResponse - getParmeter(String key)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-getParameter_S&v=newyork) or [CTIOperationResponse - getSParameters()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-getParameters&v=newyork) method.
		 * 		 * 
		 * 		 * Note: You should only store objects that can survive a JSON.parse(JSON.stringify(object)) operation. Objects not meeting this criteria may not propagate correctly through the entire operation processing chain.
		 * 		 * 
		 * 		 * For example:
		 ...
		 *
		 * Using the get/set session attribute methods enables the passing of virtually any string or number value between an operation handler and a message transformer. The sessionAttribute object can contain zero or more key/value pairs of data that are valid for the duration of a computer telephony integration provider defined session. Session attributes can also be accessed within a contact flow. The operation handler determines what session attribute key/value pairs are needed as it consumes these values. Typically the operation handler sets these attributes on the CTIOperationResponse object by calling this method and the message transformer gets the attributes using the [CTIOperationResponse - getSessionAttribute(String key)](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-getSessionAttribute_S&v=newyork) or [CTIOperationResponse - getSessionAttribute()](https://developer.servicenow.com/go_to_api.do?ID=CTIOpResp-getSessionAttributes&v=newyork) method.
		 * 		 * 
		 * 		 * Note: You should only store objects that can survive a JSON.parse(JSON.stringify(object)) operation. Objects not meeting this criteria may not propagate correctly through the entire operation processing chain.
		 * 		 * 
		 * 		 * For example:
