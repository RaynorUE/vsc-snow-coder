declare namespace sn_hr_le - Human Resources: Lifecycle Events {
	 ...
	 *   
	 * See also [Lifecycle event case management](https://docs.servicenow.com/bundle/orlando-hr-service-delivery/page/product/human-resources/concept/hr-lifecycle-event-case-management.html).
	 * 
	 */
