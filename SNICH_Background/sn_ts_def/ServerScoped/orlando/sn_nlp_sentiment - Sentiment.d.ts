declare namespace sn_nlp_sentiment - Sentiment {
	...
	class SentimentAnalyser {
		 ...
		 *
		 * @param {{[fieldName: string]: string}} inputTextArray Array of text (string) on which sentiment analysis should be performed.
		 *
