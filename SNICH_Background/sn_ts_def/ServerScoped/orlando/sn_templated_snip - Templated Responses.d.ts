declare namespace sn_templated_snip - Templated Responses {

	/** 
	 * Response templates are reusable messages that agents can copy to case or task forms. They provide quick and consistent messages to users and display standard chat response messages to requesters in Agent Chat. To access the methods in this class, the response templates plugin must be activated. This API is located in the sn_templated_snip namespace.  
	 *   
	 * For additional information on response templates, see [Response templates](https://docs.servicenow.com/bundle/orlando-servicenow-platform/page/product/human-resources/concept/response-templates-templated-snippets.html).
	 * 
	 */
