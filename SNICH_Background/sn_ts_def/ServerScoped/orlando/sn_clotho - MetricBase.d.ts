declare namespace sn_clotho - MetricBase {
	...
	class Client {
		 ...
		 *
		 * @param {GlideRecord} gr The records whose time series data for the specified metric is to be deleted.
		 ...
		 * 
		 * *   [DataBuilder](https://docs.servicenow.com/bundle/orlando-application-development/page/app-store/dev_portal/API_reference/DataBuilderScoped/concept/DataBuilderScopedAPI.html) object containing metric data.
	 ...
	 * 
	 * *   The metric() method must be called before calling a transform method.
	...
	class TransformPart {
		 ...
		 * *   STDDEV
		 * 
		 * For definitions of these options, see [MetricBase transforms](https://docs.servicenow.com/bundle/orlando-now-intelligence/page/use/reporting/reference/metricbase-transforms.html).
