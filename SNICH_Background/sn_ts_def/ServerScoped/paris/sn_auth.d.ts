declare namespace sn_auth {
	...
	class RequestAuthAPI {
		...
		/**
		 *
		 * @param {{[fieldName: string]: string}} data HttpRequestData object that contains the unsigned REST request. Use the HttpRequestData class to build this object. See [HttpRequestData API](https://developer.servicenow.com/go_to_api.do?ID=HttpRequestDataAPI&v=paris).
		 * @param {{[fieldName: string]: string}} credential Object that represents a record from the Credentials [discovery_credentials] table. Retrieve this object using the AuthCredential class. See [AuthCredential API](https://developer.servicenow.com/go_to_api.do?ID=AuthCredentialAPI&v=paris).
		 *
		 */
