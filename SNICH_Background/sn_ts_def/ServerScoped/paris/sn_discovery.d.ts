declare namespace sn_discovery {
	...
	class DiscoveryAPI {
		 ...
		 *
		 * @returns {any[]} JavaScript array of immutable [ReportCiStatusOutputJS](dev.do#!/reference/api/paris/server/sn_discovery-namespace/c_ReportCiStatusOutputJSScopedAPI "The ReportCiStatusOutputJS methods are getters that return specific object properties for the DiscoveryAPI reportCiIpAddressStatus method and then convert the information into a JSON string.") objects.
		 */
