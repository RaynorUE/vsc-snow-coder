declare namespace sn_currency {
	...
	class GlideCurrencyConverter {
		 ...
		 *
		 * @param {string} from Currency to convert from. Use the three-letter ISO currency code of the currency.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} rateTable The rate table used in currency conversons, which must extend fx_conversion_rate. If the value is undefined, fx_system_rate is used.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {string} to Currency to convert to. Use the three-letter ISO currency code of the currency.
		 *
		 * @returns {void} Method does not return a value
		 */
	...
	class GlideCurrencyExchangeValue {
		...
		/**
		 *
		 * Returns the currency conversion rate used to create the GlideCurrencyExchangeValue object.
		 *
		 *
	...
	class GlideCurrencyFormatter {
		 ...
		 *
		 * @param {number} maxFractionDigits Sets the maximum number of fraction digits to display.
		 *
		 * @returns {void} Method does not return a value
		 */
		 ...
		 *
		 * @param {number} minFractionDigits The minimum number of fraction digits to display.
		 *
		 * @returns {void} Method does not return a value
		 */
